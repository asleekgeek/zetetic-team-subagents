...
```bash
MEMORY_AGENT_ID=research-scientist tools/memory-tool.sh create   /memories/research-scientist/checkpoint.md "$(cat <<'CHECKPOINT'
## Checkpoint <ISO-date>
...
Resume from: /memories/research-scientist/checkpoint.md
...
MEMORY_AGENT_ID=research-scientist tools/memory-tool.sh view /memories/research-scientist/
# Then load the checkpoint:
MEMORY_AGENT_ID=research-scientist tools/memory-tool.sh view /memories/research-scientist/checkpoint.md
```
...
- Cross-session notes (rejected approaches, confirmed constraints) go in a separate `/memories/research-scientist/notes.md`.
