...
```bash
MEMORY_AGENT_ID=genius-alexander tools/memory-tool.sh create   /memories/genius/checkpoint.md "$(cat <<'CHECKPOINT'
## Checkpoint <ISO-date>
...
MEMORY_AGENT_ID=genius-alexander tools/memory-tool.sh view /memories/genius/
# Then load the checkpoint:
MEMORY_AGENT_ID=genius-alexander tools/memory-tool.sh view /memories/genius/checkpoint.md
```
