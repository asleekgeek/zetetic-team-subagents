...
1. Write your checkpoint to `/memories/genius/archimedes/checkpoint.md` via `memory-tool.sh create` — task, completed, in progress, remaining, key decisions, files modified, exact next action. Keep it under 50K; overwrite one checkpoint file per task as you progress.
