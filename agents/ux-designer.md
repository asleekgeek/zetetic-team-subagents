...
```bash
MEMORY_AGENT_ID=ux-designer tools/memory-tool.sh create   /memories/ux-designer/checkpoint.md "$(cat <<'CHECKPOINT'
## Checkpoint <ISO-date>
...
MEMORY_AGENT_ID=ux-designer tools/memory-tool.sh view /memories/ux-designer/checkpoint.md
```
...
- Cross-session notes (rejected approaches, confirmed constraints) go in a separate `/memories/ux-designer/notes.md`.
