...
```bash
MEMORY_AGENT_ID=reviewer-academic tools/memory-tool.sh create   /memories/reviewer-academic/checkpoint.md "$(cat <<'CHECKPOINT'
## Checkpoint <ISO-date>
...
MEMORY_AGENT_ID=reviewer-academic tools/memory-tool.sh view /memories/reviewer-academic/checkpoint.md
```
...
- Cross-session notes (rejected approaches, confirmed constraints) go in a separate `/memories/reviewer-academic/notes.md`.
