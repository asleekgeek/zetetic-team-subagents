...
```bash
MEMORY_AGENT_ID=engineer tools/memory-tool.sh create   /memories/engineer/checkpoint.md "$(cat <<'CHECKPOINT'
## Checkpoint <ISO-date>
...
MEMORY_AGENT_ID=engineer tools/memory-tool.sh view /memories/engineer/checkpoint.md
```
...
- Cross-session notes (rejected approaches, confirmed constraints) go in a separate `/memories/engineer/notes.md`.
