...
```bash
MEMORY_AGENT_ID=orchestrator tools/memory-tool.sh create   /memories/orchestrator/checkpoint.md "$(cat <<'CHECKPOINT'
## Checkpoint <ISO-date>
...
MEMORY_AGENT_ID=orchestrator tools/memory-tool.sh view /memories/orchestrator/checkpoint.md
```
...
- Cross-session notes (rejected approaches, confirmed constraints) go in a separate `/memories/orchestrator/notes.md`.
